...
from pystoned.constant import CET_ADDI, CET_MULT, FUN_PROD, FUN_COST, OPT_DEFAULT, RTS_CRS, RTS_VRS, OPT_LOCAL
from pystoned.utils import tools
...
class CNLS_LASSO:
    ...
    def __objective_rule(self):
        ...
        def objective_rule(model):
            return sum(model.epsilon[i] ** 2 for i in model.I) + model.eta*sum(model.beta[i, j] for j in model.J for i in model.I)
